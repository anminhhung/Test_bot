...
from src.readers.csv_reader_customised import PandasCSVReaderCustomised
...
def get_extractor(top_k: int = 1000):
    return {
        # ".pdf": LlamaParse(
        ...
        ".csv": PandasCSVReaderCustomised(pandas_config=dict(on_bad_lines="skip"), concat_rows=True, top_k = top_k),
