...
from database.core.s3 import S3Client
...
from .core import Assistants, Conversations, Messages, get_instance_session
...
class DatabaseManager:
    ...
    def __init__(self, setting: GlobalSettings, db_session: Optional[Session] = None):
        ...
        self.s3_client = S3Client.from_setting(setting)
